...
def excel_to_list(data_file, sheet):
    ...
    sh = wb.sheet_by_name(sheet)  # 获取工作簿对象
...
#     data_list = excel_to_list(r"E:\api_test_framework_finish\data\test_user_data.xlsx", "TestUserLogin")  # 读取excel，TestUserLogin工作簿的所有数据
